  ...
  ((e = (function () {
    ...
    (e.prototype.buildOut = function () {
      ...
      (e.$slides = e.$slider.children(e.options.slide + ':not(.slick-cloned)').addClass('slick-slide')),
        ...
        (e.$slideTrack = 0 === e.slideCount ? i('<div class="slick-track"/>').appendTo(e.$slider) : e.$slides.containerAll('<div class="slick-track"/>').parent()),
        (e.$list = e.$slideTrack.container('<div class="slick-list"/>').parent()),
