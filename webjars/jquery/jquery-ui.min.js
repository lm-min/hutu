...
!(function (t) {
      ...
      this._addClass('ui-resizable'),
        ...
        this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i) &&
          (this.element.container(
            V("<div class='ui-containerper'></div>").css({
              overflow: 'hidden',
          ...
          (this.elementIscontainerper = !0),
          (t = { marginTop: this.originalElement.css('marginTop'), marginRight: this.originalElement.css('marginRight'), marginBottom: this.originalElement.css('marginBottom'), marginLeft: this.originalElement.css('marginLeft') }),
          this.element.css(t),
  ...
  V.ui.resizable,
        ...
        (this.opos = [i.pageX, i.pageY]),
          ...
          this.options.disabled ||
            ...
            this.selectees.filter('.ui-selected').each(function () {
              ...
              (t.startselected = !0),
                i.metaKey || i.ctrlKey || (s._removeClass(t.$element, 'ui-selected'), (t.selected = !1), s._addClass(t.$element, 'ui-unselecting'), (t.unselecting = !0), s._trigger('unselecting', i, { unselecting: t.element }));
            }),
            V(i.target)
              .parents()
              .addBack()
                ...
                e
                  ...
                  : (t.selecting &&
                      ((s.metaKey || s.ctrlKey) && t.startselected
                        ...
                        : (n._removeClass(t.$element, 'ui-selecting'), (t.selecting = !1), t.startselected && (n._addClass(t.$element, 'ui-unselecting'), (t.unselecting = !0)), n._trigger('unselecting', s, { unselecting: t.element }))),
                    t.selected &&
                      (s.metaKey ||
                        s.ctrlKey ||
                        t.startselected ||
    ...
    V.widget('ui.sortable', V.ui.mouse, {
      ...
      _getParentOffset: function () {
        ...
        var t = this.offsetParent.offset();
        return (
          'absolute' === this.cssPosition && this.scrollParent[0] !== this.document[0] && V.contains(this.scrollParent[0], this.offsetParent[0]) && ((t.left += this.scrollParent.scrollLeft()), (t.top += this.scrollParent.scrollTop())),
          {
            top:
    ...
    V.widget('ui.menu', {
      ...
      _destroy: function () {
        var t = this.element.find('.ui-menu-item').removeAttr('role aria-disabled').children('.ui-menu-item-containerper').removeUniqueId().removeAttr('tabIndex role aria-haspopup');
      ...
      refresh: function () {
        ...
        this._toggleClass('ui-menu-icons', null, !!this.element.find('.ui-icon').length),
          ...
          this._addClass(e, 'ui-menu-item')._addClass(i, 'ui-menu-item-containerper'),
      ...
      focus: function (t, e) {
        ...
        this.blur(t, t && 'focus' === t.type),
          ...
          (this.active = e.first()),
          (i = this.active.children('.ui-menu-item-containerper')),
          this._addClass(i, null, 'ui-state-active'),
          this.options.role && this.element.attr('aria-activedescendant', i.attr('id')),
          (i = this.active.parent().closest('.ui-menu-item').children('.ui-menu-item-containerper')),
          this._addClass(i, null, 'ui-state-active'),
          t && 'keydown' === t.type
            ? this._close()
      ...
      blur: function (t, e) {
        e || clearTimeout(this.timer), this.active && (this._removeClass(this.active.children('.ui-menu-item-containerper'), null, 'ui-state-active'), this._trigger('blur', t, { item: this.active }), (this.active = null));
      },
      ...
      _filterMenuItems: function (t) {
        ...
        return this.activeMenu
          ...
          .filter('.ui-menu-item')
          .filter(function () {
            return e.test(String.prototype.trim.call(V(this).children('.ui-menu-item-containerper').text()));
          });
      },
    });
  ...
  V.widget('ui.controlgroup', {
    ...
    _destroy: function () {
      this._callChildMethod('destroy'),
        ...
        this.element.removeAttr('role'),
        this.options.items.controlgroupLabel && this.element.find(this.options.items.controlgroupLabel).find('.ui-controlgroup-label-contents').contents().uncontainer();
    },
        ...
        if (t)
          return 'controlgroupLabel' === s
            ? ((e = o.element.find(t)).each(function () {
                var t = V(this);
                t.children('.ui-controlgroup-label-contents').length || t.contents().containerAll("<span class='ui-controlgroup-label-contents'></span>");
              }),
      ...
      _generateHTML: function (t) {
        ...
        for (
          t.drawMonth = K,
            ...
            R = '',
            t.inline ||
              (R = V('<button>').attr({ type: 'button', class: 'ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all', 'data-handler': 'hide', 'data-event': 'click' }).text(this._get(t, 'closeText'))[0].outerHTML),
            F = '',
            E &&
              (F = V("<div class='ui-datepicker-buttonpane ui-widget-content'>")
                .append(N ? R : '')
                .append(this._isInRange(t, W) ? V('<button>').attr({ type: 'button', class: 'ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all', 'data-handler': 'today', 'data-event': 'click' }).text(A) : '')
  ...
  V.widget('ui.dialog', {
    ...
    _focusTabbable: function () {
      ...
      (t = !(t = !(t = !(t = !(t = t || this.element.find('[autofocus]')).length ? this.element.find(':tabbable') : t).length ? this.uiDialogButtonPane.find(':tabbable') : t).length ? this.uiDialogTitlebarClose.filter(':tabbable') : t)
        .length
        ? this.uiDialog
        : t)
        .eq(0)
      ...
      V.ui.formResetMixin,
      {
        ...
        _drawMenu: function () {
          ...
          (this.menu = V('<ul>', { 'aria-hidden': 'true', 'aria-labelledby': this.ids.button, id: this.ids.menu })),
            (this.menucontainer = V('<div>').append(this.menu)),
            this._addClass(this.menucontainer, 'ui-selectmenu-menu', 'ui-front'),
            this.menucontainer.appendTo(this._appendTo()),
        ...
        _refreshMenu: function () {
          ...
          this.menu.empty(),
            ...
            (this.menuItems = this.menu.find('li').not('.ui-selectmenu-optgroup').find('.ui-menu-item-containerper')),
            (this._rendered = !0),
        ...
        _position: function () {
          this.menucontainer.position(V.extend({ of: this.button }, this.options.position));
        },
        close: function (t) {
        ...
        _setOption: function (t, e) {
          ...
          'icons' === t && ((i = this.button.find('span.ui-icon')), this._removeClass(i, null, this.options.icons.button)._addClass(i, null, e.button)),
            this._super(t, e),
            'appendTo' === t && this.menucontainer.appendTo(this._appendTo()),
        ...
        _toggleAttr: function () {
          this.button.attr('aria-expanded', this.isOpen),
            this._removeClass(this.button, 'ui-selectmenu-button-' + (this.isOpen ? 'closed' : 'open'))
              ...
              ._toggleClass(this.menucontainer, 'ui-selectmenu-open', null, this.isOpen),
        ...
        _destroy: function () {
          this._unbindFormResetHandler(), this.menucontainer.remove(), this.button.remove(), this.element.show(), this.element.removeUniqueId(), this.labels.attr('for', this.ids.element);
        },
      },
    ]),
      ...
      _mouseCapture: function (t) {
        ...
        return (
          ...
          !1 !== this._start(t, o) &&
            ...
            (this._clickOffset = a
              ? { left: 0, top: 0 }
              : { left: t.pageX - e.left - n.width() / 2, top: t.pageY - e.top - n.height() / 2 - (parseInt(n.css('borderTopWidth'), 10) || 0) - (parseInt(n.css('borderBottomWidth'), 10) || 0) + (parseInt(n.css('marginTop'), 10) || 0) }),
  ...
  V.widget('ui.spinner', {
    ...
    _enhance: function () {
      this.uiSpinner = this.element.attr('autocomplete', 'off').container('<span>').parent().append('<a></a><a></a>');
    },
    _draw: function () {
      this._enhance(),
    ...
    !1 !== V.uiBackCompat &&
      V.widget('ui.spinner', V.ui.spinner, {
        _enhance: function () {
          this.uiSpinner = this.element.attr('autocomplete', 'off').container(this._uiSpinnerHtml()).parent().append(this._buttonHtml());
        },
  ...
  (V.effects = { effect: {} }),
    ...
    !1 !== V.uiBackCompat &&
      V.extend(V.effects, {
        ...
        createcontainerper: function (i) {
          if (i.parent().is('.ui-effects-containerper')) return i.parent();
          var s = { width: i.outerWidth(!0), height: i.outerHeight(!0), float: i.css('float') },
            t = V('<div></div>').addClass('ui-effects-containerper').css({ fontSize: '100%', background: 'transparent', border: 'none', margin: 0, padding: 0 }),
        ...
        removecontainerper: function (t) {
          var e = document.activeElement;
          return t.parent().is('.ui-effects-containerper') && (t.parent().replaceWith(t), (t[0] !== e && !V.contains(t[0], e)) || V(e).trigger('focus')), t;
        },
      }),
    V.extend(V.effects, {
      version: '1.13.1',
